    ...
    <div className="flex justify-center min-h-screen items-center bg-gradient-to-br from-indigo-500 via-purple-600 to-pink-500">
      <div className="w-full max-w-md backdrop-blur-lg bg-white/10 border border-white/20 shadow-2xl rounded-2xl p-8">
        ...
        <form onSubmit={handleLogin} className="space-y-5 text-white">
          ...
          <button type="submit" className="my-btn w-full bg-pink-500 hover:bg-pink-600">Login</button>
          ...
          <p className="text-center text-sm text-white/80 mt-3">
            Don’t have an account? <Link to="/register" className="text-pink-300 underline hover:text-white">Register</Link>
          </p>
        </form>
      </div>
    </div>
